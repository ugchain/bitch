 ...
 */
public class SNT extends AbstractEthContractCoin {
    private final static Log log = Logs.getLogger(SNT.class);

    public SNT(Web3j web3, Credentials credentials, byte chainId) {
        super(web3, credentials, ContractAddress.findAddress("snt"), chainId);
