 ...
 */
public class PAY extends AbstractEthContractCoin {
    private final static Log log = Logs.getLogger(PAY.class);

    public PAY(Web3j web3, Credentials credentials, byte chainId) {
        super(web3, credentials, ContractAddress.findAddress("pay"), chainId);
