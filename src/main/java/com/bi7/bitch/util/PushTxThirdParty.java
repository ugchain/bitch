...
import com.bi7.bitch.util.http.HttpsPostResponse;
...
public class PushTxThirdParty {
    ...
    public void pushTx(String rawtx) {
        pushToBlockChainInfo(rawtx);
        pushToBtcCom(rawtx);
        pushToChainQuery(rawtx);
        pushToBlockr(rawtx);
        pushToBlockExplorer(rawtx);
    }
